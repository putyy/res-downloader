  ...
  >
    <div class="rounded p-5">
        ...
        <div class="flex flex-row">
          <div>
            <div class="flex flex-row items-end">
              ...
              <div class="text-xs pl-5 text-slate-400 dark:text-app-muted">
                Version {{ store.appInfo.Version }}
              </div>
            </div>
            <div class="text-slate-400 dark:text-app-muted w-80 pt-2 pb-4">
      ...
      <div class="flex flex-col">
        ...
        <div class="grid grid-cols-5 gap-2 text-sm m-4 text-slate-400 dark:text-app-muted">
          <span v-for="item in t('footer.application').split(',')">{{ item }}</span>
        </div>
      </div>
      <div class="flex w-full text-sm justify-between pt-8 text-slate-400 dark:text-app-muted">
