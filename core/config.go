...
func getDefaultMimeMap() map[string]MimeInfo {
	return map[string]MimeInfo{
		...
		"video/x-flv":                   {Type: "video", Suffix: ".flv"},
		"application/dash+xml":          {Type: "stream", Suffix: ".mpd"},
		"application/vnd.apple.mpegurl": {Type: "stream", Suffix: ".m3u8"},
		"application/x-mpegurl":         {Type: "stream", Suffix: ".m3u8"},
		"video/m2ts":                    {Type: "stream", Suffix: ".ts"},
